...
namespace Rekaz
{
    public partial class showStudentPayment : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            Font f3 = new Font("Arial", 8, FontStyle.Bold);
            SizeF fontsizeNo = e.Graphics.MeasureString("دفعات الطالب ", f);

            e.Graphics.DrawString("دفعات الطالب : " + comboBox1.SelectedItem.ToString(), f, Brushes.Red, 330, 0);
            e.Graphics.DrawRectangle(Pens.Black, margin, 40, e.PageBounds.Width - margin * 2, e.PageBounds.Height - margin * 2);
            ...
            e.Graphics.DrawLine(Pens.Black, margin, 80, e.PageBounds.Width - margin, colHight + 20);

            e.Graphics.DrawString("القسط المدرسي", f2, Brushes.Black, e.PageBounds.Width - margin * 2 - 50, 50);
            e.Graphics.DrawLine(Pens.Black, e.PageBounds.Width - margin * 2 - 50, 40, e.PageBounds.Width - margin * 2 - 50, e.PageBounds.Height - margin);

            e.Graphics.DrawString("الزي المدرسي", f2, Brushes.Black, e.PageBounds.Width - margin * 2 - 150, 50);
            e.Graphics.DrawLine(Pens.Black, e.PageBounds.Width - margin * 2 - 150, 40, e.PageBounds.Width - margin * 2 - 150, e.PageBounds.Height - margin);

            e.Graphics.DrawString(" مواصلات", f2, Brushes.Black, e.PageBounds.Width - margin * 2 - 220, 50);
            e.Graphics.DrawLine(Pens.Black, e.PageBounds.Width - margin * 2 - 220, 40, e.PageBounds.Width - margin * 2 - 220, e.PageBounds.Height - margin);

            e.Graphics.DrawString(" كتب عامة", f2, Brushes.Black, e.PageBounds.Width - margin * 2 - 300, 50);
            e.Graphics.DrawLine(Pens.Black, e.PageBounds.Width - margin * 2 - 300, 40, e.PageBounds.Width - margin * 2 - 300, e.PageBounds.Height - margin);

            e.Graphics.DrawString(" كتب خاصة", f2, Brushes.Black, e.PageBounds.Width - margin * 2 - 380, 50);
            e.Graphics.DrawLine(Pens.Black, e.PageBounds.Width - margin * 2 - 380, 40, e.PageBounds.Width - margin * 2 - 380, e.PageBounds.Height - margin);

            e.Graphics.DrawString("  أخرى", f2, Brushes.Black, e.PageBounds.Width - margin * 2 - 450, 50);
            e.Graphics.DrawLine(Pens.Black, e.PageBounds.Width - margin * 2 - 450, 40, e.PageBounds.Width - margin * 2 - 450, e.PageBounds.Height - margin);


            e.Graphics.DrawString("المجموع", f2, Brushes.Black, e.PageBounds.Width - margin * 2 - 500, 50);
            e.Graphics.DrawLine(Pens.Black, e.PageBounds.Width - margin * 2 - 500, 40, e.PageBounds.Width - margin * 2 - 500, e.PageBounds.Height - margin);

            e.Graphics.DrawString("     التاريخ والوقت", f2, Brushes.Black, e.PageBounds.Width - margin * 2 - 620, 50);
            e.Graphics.DrawLine(Pens.Black, e.PageBounds.Width - margin * 2 - 620, 40, e.PageBounds.Width - margin * 2 - 620, e.PageBounds.Height - margin);


            e.Graphics.DrawString(" اسم المستلم", f2, Brushes.Black, e.PageBounds.Width - margin * 2 - 700, 50);
            ...
            {
                e.Graphics.DrawString(dataGridView1.Rows[i].Cells[0].Value.ToString(), f2, Brushes.Navy, e.PageBounds.Width - margin * 2 - 50, 50 + rowsHight);

                e.Graphics.DrawString(dataGridView1.Rows[i].Cells[1].Value.ToString(), f2, Brushes.Navy, e.PageBounds.Width - margin * 2 - 150, 50 + rowsHight);

                e.Graphics.DrawString(dataGridView1.Rows[i].Cells[2].Value.ToString(), f2, Brushes.Navy, e.PageBounds.Width - margin * 2 - 220, 50 + rowsHight);

                e.Graphics.DrawString(dataGridView1.Rows[i].Cells[3].Value.ToString(), f2, Brushes.Navy, e.PageBounds.Width - margin * 2 - 300, 50 + rowsHight);

                e.Graphics.DrawString(dataGridView1.Rows[i].Cells[4].Value.ToString(), f2, Brushes.Navy, e.PageBounds.Width - margin * 2 - 380, 50 + rowsHight);

                e.Graphics.DrawString(dataGridView1.Rows[i].Cells[5].Value.ToString(), f2, Brushes.Navy, e.PageBounds.Width - margin * 2 - 450, 50 + rowsHight);

                e.Graphics.DrawString(dataGridView1.Rows[i].Cells[6].Value.ToString(), f2, Brushes.Navy, e.PageBounds.Width - margin * 2 - 500, 50 + rowsHight);

                e.Graphics.DrawString(dataGridView1.Rows[i].Cells[7].Value.ToString(), f3, Brushes.Navy, e.PageBounds.Width - margin * 2 - 620, 50 + rowsHight);

                e.Graphics.DrawString(dataGridView1.Rows[i].Cells[8].Value.ToString(), f2, Brushes.Navy, e.PageBounds.Width - margin * 2 - 700, 50 + rowsHight);

                e.Graphics.DrawLine(Pens.Black, margin, 80 + rowsHight, e.PageBounds.Width - margin, 80 + rowsHight);
                rowsHight += 60;
            }
